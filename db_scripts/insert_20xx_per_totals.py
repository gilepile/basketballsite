...
endpoint_player_career_stats = "https://stats.nba.com/stats/playercareerstats"
...
while (i < (numOfPlayers)):
    ...
    parameters_per_game = {'PerMode': "Totals", 'playerID': player_id}

    resp_per_game = requests.get(endpoint_player_career_stats, headers = request_helper.request_headers, params = parameters_per_game)
    ...
    if(result_set_zero_name == "SeasonTotalsRegularSeason"):
        ...
        if(rowSet_length > 0):
            ...
            player_row = db_model.player_season_totals(
                player_count = counter,
                league_id=season_data_row[2],
                season_id = season_id_from_response,
